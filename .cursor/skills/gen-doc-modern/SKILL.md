---
name: gen-doc-modern
description: Analyze a source code repository and generate technical documentation for MODERN architectures (SPA, API, MVC). Runs in three phases with parallel sub-agents.
